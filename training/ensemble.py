...
def main(argv=None):
    ...
    p.add_argument('bundles',nargs='+',help='NPZ bundles emitted alongside submissions')
    ...
    path=PredictionSaver(a.output_dir,a.experiment_file).save(ref['test_ids'],test,
    ...
    path.with_suffix('.blend.json').write_text(json.dumps(report,indent=2))
